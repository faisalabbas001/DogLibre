...
const ChainSelectorTo = ({ selectedChain, onChainSelect, excludeChain }) => {
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <div className="flex flex-col ml-14 sm:ml-28">
          <p className="text-sm">To</p>
          <h2 className="text-lg font-bold">{selectedChain.name}</h2>
        </div>


        <div className="ml-3 shadow-md w-[50px] h-[50px] rounded-full overflow-hidden">
